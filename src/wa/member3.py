...
def eyebrow_angry():
    ...
    eyebrow_turt.penup()
    eyebrow_turt.goto(70, 130)
    eyebrow_turt.setheading(210)
    eyebrow_turt.pendown()
    eyebrow_turt.forward(70)

    eyebrow_turt.penup()
    eyebrow_turt.goto(-70, 130)
    eyebrow_turt.setheading(330)
    eyebrow_turt.pendown()
    eyebrow_turt.forward(70)
