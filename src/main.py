...
face_turt = turtle.RawTurtle(screen)
...
tk.Button(face_frame, text = "1", command = draw_face1, width = 10).grid(row = 0, column = 0, padx = 5)
tk.Button(face_frame, text = "2", command = draw_face2, width = 10).grid(row = 0, column = 1, padx = 5)
